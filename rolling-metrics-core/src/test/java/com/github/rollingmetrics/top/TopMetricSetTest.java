...
public class TopMetricSetTest {
    ...
    public void testDescriptionGauges() {
        ...
        checkDescriptions(metricSet, "my-top", TestData.first.getQueryDescription(), "", "");

        TopTestUtil.update(top, TestData.second);
        checkDescriptions(metricSet, "my-top", TestData.second.getQueryDescription(), TestData.first.getQueryDescription(), "");

        TopTestUtil.update(top, TestData.third);
        checkDescriptions(metricSet, "my-top", TestData.third.getQueryDescription(), TestData.second.getQueryDescription(), TestData.first.getQueryDescription());
    }
