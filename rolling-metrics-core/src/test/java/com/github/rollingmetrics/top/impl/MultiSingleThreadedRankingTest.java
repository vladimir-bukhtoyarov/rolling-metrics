...
public class MultiSingleThreadedRankingTest {

    private SingleThreadedRanking collector = new MultiRankingSnaphsot(2);
    private SingleThreadedRanking collector2 = new MultiRankingSnaphsot(2);
