...
package com.github.rollingmetrics.ranking.combine;
...
public class ResetPeriodicallyRankingBenchmark {
    ...
    @GroupThreads(1)
    @Benchmark
    public List<Position> getSnapshot_periodicallyRanking_10(RankingState state) {
    ...
    public static class FourThread {
        public static void main(String[] args) throws RunnerException {
            Options opt = new OptionsBuilder()
                    .include(".*" + ResetPeriodicallyRankingBenchmark.class.getSimpleName() + ".*")
                    .warmupIterations(3)
